...
public class ListaPedidosProntosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_pedidos_prontos);

        mRecyclerViewPedidos = (RecyclerView) findViewById(R.id.recyclerViewTodosOsPedidosProntos);
        ...
        referenciaFirebase.child("pedidos").orderByChild("nome").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot postSnapshot: dataSnapshot.getChildren()) {
                    if(postSnapshot.child("status").getValue().equals("Pronto")) {
